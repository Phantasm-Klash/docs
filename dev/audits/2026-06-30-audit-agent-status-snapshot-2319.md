...
- `SpellKard`: root `main...origin/main`, clean; PR #43 was merged at 2026-06-30T23:19:56Z with 2 successful checks.
...
- Open PR queue is small: Gensoulkyo #57 is merge-ready from checks, but should be reviewed before merge because it touches server callback/event contracts.
